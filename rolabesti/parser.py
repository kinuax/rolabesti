...
PARSINGS[r'/Places/([^/]+)/Genres/([^/]+)/Albums/([^/]+)/(?:([^/]+)/)?([^/]+)\.[mM][pP]3$'] = ('place', 'genre',
                                                                                               'album', 'side', 'title')
PARSINGS[r'/Places/([^/]+)/Genres/([^/]+)/([^/]+)/([^/]+)/(?:([^/]+)/)?([^/]+)\.[mM][pP]3$'] = ('place', 'genre',
                                                                                                'artist', 'album',
                                                                                                'side', 'title')
